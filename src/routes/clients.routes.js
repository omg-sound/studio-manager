...
router.get("/", (req, res) => {
  ...
  const orgCols = [
    { label: "이름", primary: true, w: "16rem" },
    { label: "유형", w: "9rem", hide: "xl", mobileHide: true },
    { label: group === "company" ? "대표" : "소속", w: "11rem", hide: "sm" },
    { label: "사업자번호", w: "9.5rem", hide: "sm" },
    { label: "전화", w: "9.5rem", hide: "xl", mobileHide: true },
    { label: "이메일", hide: "sm", mobileHide: true },
  ];
